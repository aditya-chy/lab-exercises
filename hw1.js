...
const Student = class Student {
    constructor(firstName, lastName, gpa, degtreeType) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.gpa = gpa;
        this.degreeType = degtreeType;
...
const Product = class Product {
    ...
    static printProducts = (products) => {
        ...
        products.forEach(product => {
            console.log(`Product: ${product.name}, Cost: ${formatter.format(product.price)}, Available: ${product.availability === 'In Stock' ? 'Yes' : 'No'}`);
        });
    }
